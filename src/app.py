...
st.set_page_config(page_title="Image Classifier",initial_sidebar_state="collapsed")



model = load(open(r'C:\Data Science\ML-Webapp\models\decision_tree_classifier_default_42.sav', 'rb'))
